...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul  4 08:40:35 2017
...
def dual_encoder_model(hparams,mode,context,context_len,utterance,utterance_len,targets):
    ...
    with tf.variable_scope("rnn") as vs:
        ...
        rnn_outputs, rnn_states = tf.nn.dynamic_rnn(cell,tf.concat(0,[context_embedded, utterance_embedded]),sequence_length=tf.concat(0, [context_len, utterance_len]),dtype=tf.float32)
